...
export const LoadingSpinner: React.FC<{ message?: string }> = ({ message }) => (
  <div className="flex flex-col items-center justify-center text-center p-8 rounded-lg animate-pulse-bg">
    ...
    <p className="mt-4 text-lg font-medium text-gray-300">Generating...</p>
